...
//- (instancetype)initPostFormMethod:(NSString *)methodName formDatasArray:(NSDictionary<NSString *,NSData *> *)datasArray mimeType:(NSString *)mimeType{
//    _mimeType = [mimeType copy];
//    _datasArray = [datasArray copy];
//    return [self initMethodName:methodName numOfRepeat:1 requestMethod:RequestMethodPostForm];
//}
